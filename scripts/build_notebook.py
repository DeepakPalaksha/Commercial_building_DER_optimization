...
C1 = md(
    ...
    "DSGS grid-services value stack totalling **~$45k/year** against an\n"
    "**$88k baseline annual bill** (battery dispatch via MILP 3-demand "
    "optimizer).\n\n"
    "---\n"
...
C2 = code(
    ...
    "# Use inline backend for interactive Jupyter; fall back to Agg\n"
    "# for headless nbconvert execution.\n"
    "try:\n"
